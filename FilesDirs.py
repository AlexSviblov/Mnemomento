...
destination_media = Settings.get_destination_media()
...
def transfer_const_photos(file: str, destination: str = Settings.get_destination_media() + '/Media/Photo/const/', mode: str ='copy') -> str:
...
def transfer_alone_photos(photo_directory: str, photofile: str, destination: str = Settings.get_destination_media() + '/Media/Photo/alone/', mode: str = 'copy') -> None:
    photo_directory_lastname = photo_directory.split('/')[-1]
    if not os.path.isdir(destination + photo_directory_lastname):
        os.mkdir(destination + photo_directory_lastname)
