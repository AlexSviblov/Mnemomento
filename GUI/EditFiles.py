...
class EditExifData(QDialog):
    ...
    def __init__(self, parent, photoname: str, photodirectory: str, chosen_group_type: str):
        ...
        self.latitude_fn_lbl = QLabel(self)
        self.longitude_fn_lbl = QLabel(self)
        self.latitude_fn_line = QLineEdit(self)
        self.longitude_fn_line = QLineEdit(self)
        self.latitude_dmc_lbl = QLabel(self)
        self.longitude_dmc_lbl = QLabel(self)
        self.latitude_dmc_choose = QComboBox(self)
        self.longitude_dmc_choose = QComboBox(self)
        self.latitude_dmc_deg_lbl = QLabel(self)
        self.longitude_dmc_min_lbl = QLabel(self)
        self.latitude_dmc_sec_lbl = QLabel(self)
        self.longitude_dmc_deg_lbl = QLabel(self)
        self.latitude_dmc_min_lbl = QLabel(self)
        self.longitude_dmc_sec_lbl = QLabel(self)
        self.latitude_dmc_deg_line = QLineEdit(self)
        self.latitude_dmc_min_line = QLineEdit(self)
        self.latitude_dmc_sec_line = QLineEdit(self)
        self.longitude_dmc_deg_line = QLineEdit(self)
        self.longitude_dmc_min_line = QLineEdit(self)
        self.longitude_dmc_sec_line = QLineEdit(self)
