...
# conn = sqlite3.connect('C:/Users/Public/AppData/TestForPhotoPr/tests/PhotoDB.db')   # соединение с БД
# cur = conn.cursor()
#
...
#
# conn = sqlite3.connect('C:/Users/Public/AppData/TestForPhotoPr/tests/ErrorNames.db')   # соединение с БД
# cur = conn.cursor()
#
